...
import ph.apper.android.atienza.showtracker.adapters.ShowAdapter
...
//        view.rv_show.layoutManager = GridLayoutManager(this.requireActivity().applicationContext, 3)
